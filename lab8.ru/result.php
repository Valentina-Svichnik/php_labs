...
$abc=iconv( 'cp1251', 'utf-8', $abc);
  ...
  $word_amount = str_word_count($text,0,$abc);

    echo("<table><tbody>");
    echo '<tr><td>Количество символов </td><td>'.mb_strlen($text, 'utf-8').'</td></tr>';
    echo '<tr><td>Количество букв </td><td>'.$letters_amount.' </td></tr>';
    echo'<tr><td>Количество строчных букв </td><td>'.$letters_up_amount.'</td></tr>';
    echo'<tr><td>Количество заглавных букв </td><td>'.$letters_down_amount.'</td></tr>';
    ...
    echo'<tr><td>Количество слов</td><td> '.$word_amount.'</td><tr>';
